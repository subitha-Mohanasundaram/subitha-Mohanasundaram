...
skills     : [Java, Python, React, Node.js, AI/ML, Automation]
hobbies    : [Coding, Open Source, Problem Solving, Learning]
...
| 💻 **Coding Platform** | Competitive coding platform with real-time judge | Java · React · Spring Boot |
...
<div align="center">
  <sub>⭐ Star my repos if you find them useful! Made with ❤️ by Subitha</sub>
</div>
